  ...
  - 基础
    ...
    - Spark 中的数据倾斜
      ...
      - 方案
        ...
        - 自定义Partitioner:默认为 HashPartitioner
        - 将Reduce side（侧）Join转变为Map side（侧）Join：通过Spark的Broadcast机制，将Reduce侧Join转化为Map侧Join，避免Shuffle 从而完全消除Shuffle带来的数据倾斜
